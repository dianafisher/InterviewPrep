package com.dianafisher.interviewbit.dynamic_programming.best_time_to_buy_and_sell_stocks_II;
...
//        System.out.println();
    ...
    class Transaction {
        ...
        public Transaction(int start, int end, int profit) {
            this.start = start;
            this.end = end;
            this.profit = profit;
        }
