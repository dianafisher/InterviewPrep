...
public class LongestSubstringWithoutRepeat {
    ...
    public int lengthOfLongestSubstring(String a) {
        ...
        int curLen = 0;
        int prevIndex = 0;
        // map character to index in string
...
//            System.out.println("map = " + map);
            if (map.containsKey(ch)) {
                ...
                curLen = Math.min(curLen+1, i-prevIndex);
                // update the hashmap with this index of ch
                map.put(ch, i);
            } else {
                curLen += 1;
                map.put(ch, i);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.lengthOfLongestSubstring("dadbc")); // 4
